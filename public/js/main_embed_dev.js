define(['jquery', 'underscore', 'app', 'marionette', 'backbone', 'core/view.base', 'core/listenerCollection', './scripts.template.standard.model', './scripts.template.standard.view',
    'core/aceBinder'],
  function ($, _, app, Marionette, Backbone, ViewBase, ListenerCollection, TemplateStandardModel, TemplateStandardView, aceBinder) {
    app.options.scripts = $.extend(app.options.scripts, {
